...
# Copyright (c) 2021-2025 Matff4 ORG
# Author: vhsdream
# License: MIT | https://github.com/Matff4/ProxmoxVE/raw/main/LICENSE
...
function update_script() {
  ...
  if [[ -f /etc/apt/sources.list.d/immich.list ]]; then
    ...
    msg_error "Please visit https://github.com/Matff4/ProxmoxVE/discussions/7726 for details."
    echo "${TAB3}  If you have upgraded your LXC to Trixie and you still see this message, please open an Issue in the Matff4 repo."
    exit
  fi
